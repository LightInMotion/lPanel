...
#define JUCE_JNI_CALLBACK(className, methodName, returnType, params) \
  extern "C" __attribute__ ((visibility("default"))) returnType Java_com_limsc_iPanel_ ## className ## _ ## methodName params
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD) \
 ...
 METHOD (createNewView,          "createNewView",        "(Z)Lcom/limsc/iPanel/ComponentPeerView;") \
 METHOD (deleteView,             "deleteView",           "(Lcom/limsc/iPanel/ComponentPeerView;)V") \
