      ...
      gmLabel (0)
{
    ...
    gmFullOffButton->setImages (false, true, false,
                                ...
                                Image(), 1.0000f, Colour (0x0),
                                Image(), 1.0000f, Colour (0x20000000));
    addAndMakeVisible (gmLabel = new Label (L"gmLabel",
                                            L"GM"));
    gmLabel->setFont (Font (20.0000f, Font::plain));
...
void LivePanelComponent::resized()
{
    ...
    gmLabel->setBounds (proportionOfWidth (0.0249f), proportionOfHeight (0.5446f), proportionOfWidth (0.2118f), proportionOfHeight (0.0446f));
...
<JUCER_COMPONENT documentType="Component" className="LivePanelComponent" componentName=""
  ...
  <IMAGEBUTTON name="gm full off" id="9d0d0e118f2bfe08" memberName="gmFullOffButton"
               ...
               opacityOver="1" colourOver="0" resourceDown="" opacityDown="1"
               colourDown="20000000"/>
  <LABEL name="gmLabel" id="63c9b48faf1995" memberName="gmLabel" virtualName=""
         explicitFocusOrder="0" pos="2.492% 54.464% 21.184% 4.464%" textCol="ffffffff"
